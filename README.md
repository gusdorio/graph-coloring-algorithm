# This project have as approach create an algorithm to coloring a graph with a n given number of nodes and colors, in a way that adjacenty nodes cannot have the same color. 
